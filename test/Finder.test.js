...
describe('Finder', function () {
    it('Finds all step directions for a isolated pebble', function () {
        const surakarta = Surakarta.fromState(generateState([
            { row: 3, col: 3, player: 'red' }
        ]))

        const simpleFreedoms = Finder.exploreSimpleSteps(surakarta, new Position(3, 3))
    ...
    it('Reports no attacks, four simple moves for an orthogonally clogged pebble', function () {
        const surakarta = Surakarta.fromState([
            ...
            NOT_FILLED, NOT_FILLED, RED_PLAYER, NOT_FILLED, NOT_FILLED, NOT_FILLED,
        ...
        const attacks = Finder.exploreAttacks(
            surakarta,
            new Position(2, 2))

        const simples = Finder.exploreSimpleSteps(
            surakarta,
            new Position(2, 2))
    ...
    it('Finds the correct attack direction for given board', function () {
        const surakarta = Surakarta.fromState([
            NOT_FILLED, NOT_FILLED, NOT_FILLED, NOT_FILLED, NOT_FILLED, NOT_FILLED,
            NOT_FILLED, RED_PLAYER, BLACK_PLAYER, RED_PLAYER, NOT_FILLED, NOT_FILLED,
            NOT_FILLED, RED_PLAYER, RED_PLAYER, RED_PLAYER, NOT_FILLED, NOT_FILLED,
            NOT_FILLED, RED_PLAYER, RED_PLAYER, RED_PLAYER, NOT_FILLED, NOT_FILLED,
            NOT_FILLED, NOT_FILLED, NOT_FILLED, NOT_FILLED, NOT_FILLED, NOT_FILLED,
            NOT_FILLED, NOT_FILLED, NOT_FILLED, NOT_FILLED, NOT_FILLED, NOT_FILLED
